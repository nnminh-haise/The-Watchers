...
We used PostgreSQL DBMS for our project. We've set up a server on an EC2 instance on AWS service. Below is a SQL code for that DB.

*You can find the ERD and Diagram in out week 1 report!*

**File:** `The_watchers_db_schema.sql`
